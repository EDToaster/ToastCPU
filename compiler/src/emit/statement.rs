...
pub fn emit_statement(block_id: &str, s: &Statement, global_state: &mut GlobalState, function_state: &mut FunctionState,
                      stack_view: &mut Stack<Type>, counter: &mut i32, subblock_counter: &mut i32) -> Result<String, (Span, String)> {
    ...
    push! t0
                        ...
                        // is an inline value
                        let expansion = emit_statement(block_id, &statement, global_state, function_state, stack_view, counter, subblock_counter)?;
                        tasm!(
                            block;;
                            r"
{expansion}
